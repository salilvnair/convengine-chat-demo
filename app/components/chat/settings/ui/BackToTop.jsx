...
export function BackToTop() {
  ...
  return (
    <button
      ...
      title="Back to top"
      className="fixed bottom-24 right-12 sm:bottom-24 sm:right-8 z-[1200] w-10 h-10 rounded-full bg-indigo-500 hover:bg-indigo-600 text-white shadow-lg ring-1 ring-white/70 flex items-center justify-center transition-all hover:scale-110 active:scale-95"
    >
