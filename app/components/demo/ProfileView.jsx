  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Your personal details and account preferences.</p>
      </div>

      {/* Avatar row */}
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 p-6 flex items-center gap-5">
        ...
        <div>
          <p className="font-semibold text-slate-800 dark:text-slate-100">Salil Nair</p>
          <p className="text-sm text-slate-500 dark:text-slate-400">salil@example.com · Admin</p>
        </div>
        <button className="ml-auto text-sm text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-700 bg-indigo-50 dark:bg-indigo-900/40 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 rounded-lg px-4 py-2 transition-colors">
          Change photo
        </button>
      </div>
      ...
      <Section title="Personal Information">
        <Field label="Full name">
          <input defaultValue="Salil Nair"
            className="w-full text-sm border border-slate-200 dark:border-slate-600 rounded-lg px-3 py-2 outline-none focus:border-indigo-400 bg-white dark:bg-slate-700 dark:text-slate-100" />
        </Field>
        <Field label="Email">
      ...
      <div className="flex justify-end gap-3 pt-1">
        <button className="text-sm text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 px-4 py-2 rounded-lg transition-colors">
          Discard
        </button>
        <button
