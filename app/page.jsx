...
function QuickstartApp({ onBack, darkMode, onToggleDark }) {
  ...
  const [chatSettings, setChatSettings] = useState({
    ...
    // Composer attachments + agent chip (>= 1.6) — also mirrored from
    // ChatSettingsView's defaults.
      ...
      {resolvedMode !== 'fullscreen' && (
        <ConvEngineChat
          ...
          config={{
            ...
            attachmentChipBg:        chatSettings.attachmentChipBg,
            attachmentChipBorder:    chatSettings.attachmentChipBorder,
            attachmentChipIconColor: chatSettings.attachmentChipIconColor,
            attachmentChipTextColor: chatSettings.attachmentChipTextColor,
            queueItemTextColor:      chatSettings.queueItemTextColor,
            feedbackUpColor:          chatSettings.feedbackUpColor,
            feedbackUpRestingColor:   chatSettings.feedbackUpRestingColor,
            feedbackDownColor:        chatSettings.feedbackDownColor,
            feedbackDownRestingColor: chatSettings.feedbackDownRestingColor,
            feedbackClickAnimation: chatSettings.feedbackClickAnimation !== false,
            maxQueuedMessages: chatSettings.maxQueuedMessages ?? 5,
            queueColors: [
              chatSettings.queueColor1, chatSettings.queueColor2, chatSettings.queueColor3,
              chatSettings.queueColor4, chatSettings.queueColor5,
            ].some(Boolean) ? [
              chatSettings.queueColor1 || undefined, chatSettings.queueColor2 || undefined,
              chatSettings.queueColor3 || undefined, chatSettings.queueColor4 || undefined,
              chatSettings.queueColor5 || undefined,
            ] : undefined,
